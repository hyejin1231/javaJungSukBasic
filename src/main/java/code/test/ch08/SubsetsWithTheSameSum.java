...
public class SubsetsWithTheSameSum
{
	static int n, total;
	static int[] arr;
	public String DFS(int L, int sum) // L : Level, sum : 원소의 총 합
	{
		String answer = "YES";
	...
	{
		SubsetsWithTheSameSum subsetsWithTheSameSum = new SubsetsWithTheSameSum();
		...
		String result = subsetsWithTheSameSum.DFS(0, 0);
